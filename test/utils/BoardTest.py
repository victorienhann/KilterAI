...
class BoardTest(unittest.TestCase):
    ...
    def test_create_board(self):
        ...
        name = "16 x 12"
        board = Board.create_board(conn, name, description)
        layout_id = 1
        set_id = [1, 20]
        edge_left, edge_right, edge_bottom, edge_top = -24, 168, 0, 156
        images = ["product_sizes_layouts_sets/original-16x12-bolt-ons-v2.png", "product_sizes_layouts_sets/original-16x12-screw-ons-v2.png"]
        ...
        self.assertEqual(board.images, images)
